...
public sealed class ModelCatalog : IDisposable
{
        ...
        string? MeshNameContains = null)
    {
        ...
        /// <summary>
        /// A humanoid generated by us faces the same way as the vehicles, but its
        /// longest <em>horizontal</em> axis is its shoulders rather than its depth,
        /// so the automatic aligner turns it a quarter turn. This puts it back.
        /// </summary>
        private const float FigureYaw = -90f;
        ...
        private static readonly Dictionary<int, ModelSpec> Specs = new()
        {
            ...
            [CacheKeyOf(Faction.Soviet, UnitKind.Factory)] = new("Generated", "soviet_factory.glb", 16f, GeneratedYaw),
            ...
            [CacheKeyOf(Faction.Chinese, UnitKind.Factory)] = new("Generated", "chinese_factory.glb", 15f, GeneratedYaw),
            [CacheKeyOf(Faction.Chinese, UnitKind.DesignBureau)] = new("Generated", "chinese_bureau.glb", 13f, GeneratedYaw),
            ...
            [CacheKeyOf(Faction.Western, UnitKind.PowerPlant)] = new("Generated", "western_power.glb", 13f, GeneratedYaw),
            [CacheKeyOf(Faction.Western, UnitKind.Factory)] = new("Generated", "western_factory.glb", 17f, GeneratedYaw),
